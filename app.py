...
with tab_admin:
    ...
    if default_admin_week > 10:
        default_admin_week = 10
    ...
    with st.form("admin_actuals_form"):
        ...
        act_handshake_stamps = st.text_input("Handshake Video Timestamps & Context (e.g. 'Clara @ 14:22 Signature, Tom @ 42:10 Showstopper')", value="", key=f"handshake_stamps_w{admin_selected_week}")

        st.markdown("### 😢 Crying Incidents & Video Timestamps")
        act_crying_stamps = st.text_input("Crying Scene Video Timestamps & Context (e.g. 'Gabe @ 24:15 Technical, Molly @ 54:02 Elimination')", value="", key=f"crying_stamps_w{admin_selected_week}")
